...
QVector<RoutePoint::FieldType> RoutePoint::getGoingUpTypes() {
  QVector<FieldType> typesGoingUp = {FieldType::EXIT_POINT, FieldType::LADDER_UP, FieldType::ROPE_FIELD, FieldType::STAIRS_UP,
                                     FieldType::TELEPORT};
  return typesGoingUp;
};
QVector<RoutePoint::FieldType> RoutePoint::getGoingDownTypes() {
  QVector<FieldType> typesGoingDown = {
      FieldType::EXIT_POINT,  FieldType::LADDER_DOWN, FieldType::SHOVEL_HOLE_ALWAYS_OPEN, FieldType::SHOVEL_HOLE_NEED_SHOVEL,
      FieldType::STAIRS_DOWN, FieldType::TELEPORT};
  return typesGoingDown;
};
QVector<RoutePoint::FieldType> RoutePoint::getStayingSameLevelTypes() {
  QVector<FieldType> typesGoingSameLevel = {FieldType::EXIT_POINT, FieldType::REGULAR, FieldType::TELEPORT};
