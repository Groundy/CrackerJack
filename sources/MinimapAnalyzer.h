...
class MinimapAnalyzer : public QThread {
 ...
 private:
  ...
  const int MIN_X_MAP_INDEX = 124, MAX_X_MAP_INDEX = 134, MIN_Y_MAP_INDEX = 121,
            MAX_Y_MAP_INDEX = 129;
  ...
  QList<QPoint> findStartPosOfImgMap(const QImage& imgToFind,
                                     const QImage& imgToSearchWithin,
                                     QRect frameInBigWindow);
